...
public class HeroService {
    ...
    public Hero findByRace(Race race) {
     ...
     public Hero findByProfession(String profession) {
    	 return heroRepository.findByProfession(profession);
     }
	...
	public List<Item> updatePlayerInventory(List<Item> playerInventory) {
